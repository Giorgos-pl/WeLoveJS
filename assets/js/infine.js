$(document).ready(function() {
    $('.countdown').countdown(
      {
        start: new Date(2013, 9, 26, 10, 45, 0, 0).getTime() / 1000,
        end: new Date(2013, 9, 26, 17, 30, 0, 0).getTime() / 1000,
    ...
    var options = {
        ...
        center: new google.maps.LatLng(41.436909, 2.180961),
        zoom: 16,
    ...
    new google.maps.Marker({
        position: new google.maps.LatLng(41.436909, 2.180961),
        map: map
    });
